...
@interface CalendarDayBottomDotsView ()
...
@implementation CalendarDayBottomDotsView
...
- (UIImage *)solidCircleImageWithColor:(UIColor *)color{
    UIImage *image = [UIImage ext_solidCircleImageWithDiameter:self.diameter color:color];
    return image;
}
