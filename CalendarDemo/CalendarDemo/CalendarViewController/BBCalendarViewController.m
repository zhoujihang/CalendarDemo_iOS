...
@implementation BBCalendarViewController
...
- (void)setupViews{
    ...
    BBCalendarView *calendarView = [[BBCalendarView alloc] init];
    calendarView.m_Delegate = self;
    [self.s_BackdropScrollView addSubview:calendarView];
    self.s_CalendarView = calendarView;
}
- (void)setupNavigationBarView{
    BBCalendarNavBarView *navBarView = [[BBCalendarNavBarView alloc] init];
