...
#import "CalendarNavBarTitleView.h"
#import "UIImage+Extension.h"

@interface CalendarNavBarView () <CalendarNavBarTitleViewDelegate>

@property (nonatomic, weak) UIButton *s_BackBtn;
@property (nonatomic, weak) UIButton *s_TodayBtn;
@property (nonatomic, weak) CalendarNavBarTitleView *s_TitleView;
@property (nonatomic, weak) UIButton *s_RightBtn;

@end

@implementation CalendarNavBarView
...
- (void)setup{
    self.backgroundColor = [UIColor ext_hexColor:@"#00bcd4"];
    [self setupViews];
...
- (void)setupViews{
    ...
    UIImage *circleImage = [UIImage ext_solidCircleImageWithDiameter:30 color:[UIColor lightGrayColor]];
    ...
    CalendarNavBarTitleView *titleView = [[CalendarNavBarTitleView alloc] init];
