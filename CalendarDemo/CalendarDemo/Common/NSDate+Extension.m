...
- (NSInteger)ext_chineseYear{
    return [self ext_chineseDateComponents].year;
}
- (NSInteger)ext_chineseMonth{
    return [self ext_chineseDateComponents].month;
}
- (NSInteger)ext_chineseDay{
    return [self ext_chineseDateComponents].day;
}
- (NSString *)ext_chineseYearString{
    ...
    NSInteger year = [self ext_chineseYear];
...
- (NSString *)ext_chineseMonthString{
    NSArray *chineseMonths=[NSArray arrayWithObjects:
                            ...
                            @"九月", @"十月", @"冬月", @"腊月", nil];
    NSInteger month = [self ext_chineseMonth];
...
- (NSString *)ext_chineseDayString{
    ...
    NSInteger day = [self ext_chineseDay];
